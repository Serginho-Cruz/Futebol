...
import 'package:futebol/src/data/usecases/get_matchs_by_group_impl.dart';
...
void main() {
  group("Usecase GetMatchsByGroup is working", () {
    ...
    test("Returns a List of SoccerMatch when no errors occur", () async {
      ...
      when(repository.getMatchsByGroup(any)).thenAnswer((_) async => Right(
          List.generate(4, (_) => MatchFactory.generateMatchWithGroup(group))));
