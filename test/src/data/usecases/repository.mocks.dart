...
// in futebol/test/src/data/usecases/get_all_selecoes_impl_test.dart.
...
class MockRepositoryMock extends _i1.Mock implements _i3.RepositoryMock {
  ...
  _i4.Future<_i2.Either<_i5.Failure, List<_i6.Selecao>>> getSelecoesByGroup(
          String group) =>
      (super.noSuchMethod(Invocation.method(#getSelecoesByGroup, []),
              returnValue:
                  _i4.Future<_i2.Either<_i5.Failure, List<_i6.Selecao>>>.value(
                      _FakeEither_0<_i5.Failure, List<_i6.Selecao>>(
                          this, Invocation.method(#getSelecoesByGroup, []))))
          as _i4.Future<_i2.Either<_i5.Failure, List<_i6.Selecao>>>);
}
